...
##     # Direct subdirectories of subspec 
##     stages   = ["estimation"]

##     # Subdirectories of each element in stages
##     subpaths = ["raw", "work", "figures", "tables"]

##     # Create each new directory that needs to be made
##     for stage in stages
##         for subpath in subpaths 
##             if !ispath(path=joinpath(savepath, stage, subpath))
##                 mkdir(path)
##                 info("Created $path")
##             end
##         end
...
>>>>>>> New settings in progress; this should be on settings branch
