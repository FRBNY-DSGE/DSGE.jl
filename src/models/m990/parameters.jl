...
function Parameters990(spec::Dict{String, Any})
    ...
    zeta_p = Param(0.8940, false, (1e-5, 0.999), BetaAlt(0.5, 0.1), 1, (1e-5, 0.999))
    iota_p = Param(0.1865, false, (1e-5, 0.999), BetaAlt(0.5, 0.15), 1, (1e-5, 0.999))
    del = 0.025
    ups = Param(1.000, true, (0., 10.), GammaAlt(1., 0.5), 2, (1e-5, 0.))
    Bigphi = Param(1.1066, false, (1., 10.), Normal(1.25, 0.12), 2, (1.00, 10.00))
    s2 = Param(2.7314, false, (-15., 15.), Normal(4., 1.5), 0, (-15., 15.))
    h = Param(0.5347, false, (1e-5, 0.999), BetaAlt(0.7, 0.1), 1, (1e-5, 0.999))
    ppsi = Param(0.6862, false, (1e-5, 0.999), BetaAlt(0.5, 0.15), 1, (1e-5, 0.999))
    nu_l = Param(2.5975, false, (1e-5, 10.), Normal(2, 0.75), 2, (1e-5, 10.))
    zeta_w = Param(0.9291, false, (1e-5, 0.999), BetaAlt(0.5, 0.1), 1, (1e-5, 0.999))
    iota_w = Param(0.2992, false, (1e-5, 0.999), BetaAlt(0.5, 0.15), 1, (1e-5, 0.999))
    law = 1.5
    # laf = []
    bet = Param(0.1402, scalefunction = x -> 1/(1 + x/100), false, (1e-5, 10.), GammaAlt(0.25, 0.1), 2, (1e-5, 10.))
    ...
    pistar = Param(0.5000, scalefunction = x -> 1 + x/100, true, (1e-5, 10.), GammaAlt(0.75, 0.4), 2, (1e-5, 10.))
    sigmac = Param(0.8719, false, (1e-5, 10.), Normal(1.5, 0.37), 2, (1e-5, 10.))
    rho = Param(0.7126, false, (1e-5, 0.999), BetaAlt(0.75, 0.10), 1, (1e-5, 0.999))
    epsp = 10.
    epsw = 10.

    # financial frictions parameters
    Fom = Param(0.0300, scalefunction = x -> 1 - (1-x)^0.25, true, (1e-5, 0.99999), BetaAlt(0.03, 0.01), 1, (1e-5, 0.99))
    sprd = Param(1.7444, scalefunction = x -> (1 + x/100)^0.25, false, (0., 100.), GammaAlt(2., 0.1), 2, (1e-5, 0.))
    zeta_spb = Param(0.0559, false, (1e-5, 0.99999), BetaAlt(0.05, 0.005), 1, (1e-5, 0.99))
    gammstar = Param(0.9900, true, (1e-5, 0.99999), BetaAlt(0.99, 0.002), 1, (1e-5, 0.99))
    ...
    ρ_g = Param(0.9863, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_b = Param(0.9410, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_mu = Param(0.8735, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_z = Param(0.9446, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_laf = Param(0.8827, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_law = Param(0.3884, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_rm = Param(0.2135, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_sigw = Param(0.9898, false, (1e-5, 0.99999), BetaAlt(0.75, 0.15), 1, (1e-5, 0.99))
    ρ_mue = Param(0.7500, true, (1e-5, 0.99999), BetaAlt(0.75, 0.15), 1, (1e-5, 0.99))
    ρ_gamm = Param(0.7500, true, (1e-5, 0.99999), BetaAlt(0.75, 0.15), 1, (1e-5, 0.99))
    ρ_pist = Param(0.9900, true, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_lr = Param(0.6936, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_zp = Param(0.8910, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_tfp = Param(0.1953, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_gdpdef = Param(0.5379, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ρ_pce = Param(0.2320, false, (1e-5, 0.999), BetaAlt(0.5, 0.2), 1, (1e-5, 0.999))
    ...
    eta_gz = Param(0.8400, false, (1e-5, 0.999), BetaAlt(0.50, 0.20), 1, (1e-5, 0.999))
    eta_laf = Param(0.7892, false, (1e-5, 0.999), BetaAlt(0.50, 0.20), 1, (1e-5, 0.999))
    eta_law = Param(0.4226, false, (1e-5, 0.999), BetaAlt(0.50, 0.20), 1, (1e-5, 0.999))

    modelalp_ind = Param(0.0000, true, (0.000, 1.000), BetaAlt(0.50, 0.20), 0, (0., 0.))
