function init_pseudo_observable_mappings!(m::Model904)
    ...
    pseudo_names = [:y_t, :y_f_t, :NaturalRate, :π_t, :OutputGap, :ExAnteRealRate, :LongRunInflation,
                    ...
                    :NominalFFR, :RealFFR, :ExpectedNominalNaturalRate, :SInf, :SInf_t1, :SInf_t2, :SInf_t3, :Pi_Til]
    ...
    pseudo[:SInf].name = "S Infinity"
    pseudo[:SInf].longname = "S Infinity"
    # pseudo[:SInf].rev_transform = quartertoannual

    pseudo[:Pi_Til].name = "Pi Tilde"
    pseudo[:Pi_Til].longname = "Pi Tilde"
    pseudo[:Pi_Til].rev_transform = quartertoannual
