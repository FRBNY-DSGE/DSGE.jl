...
function ss79!(m::Model1002)
    ...
    if !haskey(get_settings(m), :model2para_regime) # check if it was set by custom_settings already
        ...
        # Contemporaneous COVID-19 shocks
        for pk in [:σ_φ, :σ_ziid, :σ_biidc]
            # map 1959:Q3-2019:Q4 to parameter regime 1, 2020:Q1-Q2 to para regime 2,
            # 2020:Q3 to para regime 1, and 2020:Q4 to para regime 3
            # OTHERWISE, ss79 is identical to ss64
            m2p[pk] = Dict(1 => 1, 2 => 2, 3 => 2, 4 => 1, 5 => 3)
            for i in 6:get_setting(m, :n_regimes)  # map 2021:Q1 onward to para regime 1
                m2p[pk][i] = 1
            end
...
function ss81!(m::Model1002)
    ...
    if !haskey(get_settings(m), :model2para_regime) # check if it was set by custom_settings already
        ...
        # Contemporaneous COVID-19 shocks
        for pk in [:σ_φ, :σ_ziid, :σ_biidc]
            # map 1959:Q3-2019:Q4 to parameter regime 1, 2020:Q1-Q2 to para regime 2, 2020:Q3 to para regime 2, 2020:Q4 to para regime 3
...
function ss83!(m::Model1002)
    ...
    if !haskey(get_settings(m), :model2para_regime) # check if it was set by custom_settings already
        ...
        # Contemporaneous COVID-19 shocks
        for pk in [:σ_φ, :σ_ziid, :σ_biidc]
            # map 1959:Q3-2019:Q4 to parameter regime 1, 2020:Q1-Q2 to para regime 2, 2020:Q3 to para regime 1, 2020:Q4 to para regime 3
