...
module DSGE
    ...
    export
        ...
        mutation, smc, nearestSPD, tpf, tpf_testing, tpf_testing2, mutation_problem, mutation_problem2,
		mutation_problem3, mutation_small, tpf_fixed_phi, mutation_matlab, tpf_matlab, 
