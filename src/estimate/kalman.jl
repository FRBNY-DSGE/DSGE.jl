...
function kalcvf2NaN_test{S<:FloatingPoint}(data::Array{S, 2}, lead::Int64, a::Array{S, 2}, F::Array{S, 2}, b::Array{S, 2}, H::Array{S, 2}, var::Array{S, 2}, z0::Array{S, 2}, vz0::Array{S, 2})
    T = size(data, 2)
    Nz = size(a, 1)
    Ny = size(b, 1)
