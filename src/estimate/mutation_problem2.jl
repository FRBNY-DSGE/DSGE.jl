...
function mutation_problem2(c::Float64, N_MH::Int64, deterministic::Bool, system::System{Float64}, yt::Array{Float64,1}, s_init::Array{Float64,1}, ε_init::Array{Float64,1}, cov_s::Array{Float64,2}, nonmissing::Array{Bool,1}, distCall::Bool) 
   #------------------------------------------------------------------------
    # Setup
    #------------------------------------------------------------------------
