...
# Koopman smoother with anticipated shocks
alpha_hat, eta_hat = koopman_smoother(m, data, system, kal[:z0], kal[:vz0], kal[:pred], kal[:vpred])
...
# Carter-Kohn smoother with anticipated shocks
...
alpha_hat, eta_hat = koopman_smoother(m, data, system, z0, P0, kal[:pred], kal[:vpred])
