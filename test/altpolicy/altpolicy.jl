...
m = Model1002(; testing = true, custom_settings = Dict{Symbol, Setting}(:add_pgap => Setting(:add_pgap, true)))
my = Model1002(; testing = true, custom_settings = Dict{Symbol, Setting}(:add_pgap => Setting(:add_pgap, true),
