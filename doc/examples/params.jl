...
:ψ1=>"psi1",:ψ2=>"psi2",:ψ3=>"psi3",:π_star=>"pistar",:σ_c=>"sigmac",:ρ=>"rho",:ϵ_p=>"epsp",:ϵ_w=>"epsw",:Fω=>"Fom_",:spr=>"sprd_",:ζ_spb=>"zeta_spb",:γ_star=>"gammstar",:γ=>"gam_",:Lmean=>"Lmean",
...
params = Dict(p[v.key] => v.value for v in m.parameters);
