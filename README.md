...
Documentation for the *code* can be accessed by clicking on the `docs|latest` button above or this [link](https://frbny-dsge.github.io/DSGE.jl/latest). For documentation about the most recent *model version*, read this [pdf](https://github.com/FRBNY-DSGE/DSGE.jl/blob/master/docs/DSGE_Model_Documentation_1002.pdf).
